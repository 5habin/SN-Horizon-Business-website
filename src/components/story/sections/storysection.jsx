...
import './storysec/storysection.css';
import storyimg from './storysec/storysec.png';
  ...
  return (
    <div className='storysec'>
        ...
        <div className='story-wrap'>
            <p>
                SN Horizon was founded by <strong>Rafeek Mhammed </strong>with a clear vision to address the growing need for consumer product companies to embrace data, AI, 
